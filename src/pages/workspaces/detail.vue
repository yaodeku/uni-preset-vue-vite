<template>
  <view class="screen-container">
    <text class="screen-title">工作空间详情</text>
    <view v-if="workspace">
      <view class="form-field"><input class="text-input" v-model="workspace.name" placeholder="名称" /></view>
      <view class="form-field"><input class="text-input" v-model="workspace.description" placeholder="描述" /></view>
